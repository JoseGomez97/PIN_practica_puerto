(define (problem tower6)
   (:domain puerto)
    ...
    (:init
        ...
        (is-objective c7)
        ;;DOMINIO TEMPORAL
        (= (time-transport dock1 dock2) 1)
        (= (time-transport dock2 dock1) 1)
        (= (time-per-height l1) 0.6)
        (= (time-per-height l2) 0.4)
        (= (time-per-height l3) 0.2)
        (= (weight c1) 50)
        (= (weight c2) 50)
        (= (weight c3) 50)
        (= (weight c4) 50)
        ...
        (= (weight c10) 50)
        (= (weight c11) 50)
        (= (time-put-take-band band1) 0.1)
        (= (time-put-take-band band2) 0.1)
