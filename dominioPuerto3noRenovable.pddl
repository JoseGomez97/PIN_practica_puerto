...
(:durative-action take-from-stack
    ...
    :condition (and 
        ...
        (at start (>= (crane-fuel ?crane)
            (/ 10 (* (weight ?container) (time-per-height ?l1)))
        ))
    )
    :effect (and 
...
(:durative-action put-on-container
    ...
    :condition (and 
        ...
        (at start (>= (crane-fuel ?crane)
            (/ 10 (* (weight ?c1) (time-per-height ?l1)))
        ))
    )
    :effect (and 
...
(:durative-action put-green-on-green
    ...
    :condition (and 
        ...
        (at start (>= (crane-fuel ?crane)
            (/ 10 (* (weight ?container) (time-per-height ?level)))
        ))
        (over all (at ?crane ?dock))
...
(:durative-action put-on-band
    ...
    :condition (and 
        ...
        (at start (free ?band))
        (at start (>= (crane-fuel ?crane)
            (/ 10 (* (weight ?container) (time-put-take-band ?band)))
        ))
        (over all (at ?crane ?dock))
